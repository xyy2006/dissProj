...
######## 9/24/11 (came over to 1527 Arden Vista Ct for its wireless cnnection)
...
simPathAR1SNP<-function(nGenes=20, nGenes1=1, nSNPs=NULL,
...
######## firsdt SNP in each causal gene.
######## Wei Pan, weip@biostat.umn.edu
######## 12/14/14 (came over to 1527 Arden Vista Ct for its wireless cnnection)
...
simPathAR1SNPv2<-function(nGenes=20, nGenes1=1, nSNPs=NULL, ncSNPs = NULL,
