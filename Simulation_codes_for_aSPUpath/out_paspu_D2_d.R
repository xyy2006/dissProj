...
#        dat1<-simPathIndSNP(nGenes=20, nGenes1=10, nSNPlow=1, nSNPup=20, nSNP0=1,
#                            LOR=LORs[iLOR],
#                            n=500, MAFslow=0.05, MAFsup=0.4, p0=0.05)

        dat1<-simPathAR1SNP2v2(nGenes=20, nGenes1=10, nSNPlow=1, nSNPup=20, nSNP0=1:3,
                            LOR=LORs[iLOR],
                            n=500, MAFslow=0.05, MAFsup=0.4, p0=0.05)
...
save(Res, file = "out_paspu_D2_d.RData")
