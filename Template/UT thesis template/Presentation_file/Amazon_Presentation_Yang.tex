...
\begin{document}
\title[Amazon] % (optional, only for long titles)
...
%%%%%%%
\item Another merit of the longitudinal study is its ability to distinguish the degree of variation in $Y$ across time for one subject from the variation in $Y$ across subjects. 
...
\item Aim 2: Longitudinal aSPU family tests on Rare Variants
...
%\end{figure}
 ...
 \begin{figure}
        ...
        \begin{minipage}{.5\textwidth}
            \centering
            \includegraphics[width=.6\linewidth]{figure/QA_amazon}
            %\caption{A subfigure}
        \end{minipage}%
        \begin{minipage}{.5\textwidth}
            \centering
