...
\begin{document}
\title[UTSPH] % (optional, only for long titles)
...
\caption{ GWAS contribute to personalized medicine}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Aim 1: A data-adaptive association test for longitudinal data analysis within GEE framework}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{
...
\frame[allowframebreaks]{
\frametitle{Aim 1}
\framesubtitle{Methods: introduction to notation and formula}
\scriptsize
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Aim 2: Longitudinal aSPU family tests on Rare Variants}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{
...
\newpage
\item An effort to combine the advantages from aSPU, aSPUw and score test. The aSPU.aSPUw.Score test can save user's effort in deploying a best version of aSPU family test on a specific dataset with only a small amount of power loss in the process of compromising among different versions.
$$
...
\vspace{-10pt}
\caption{Empirical power benchmark with aSPU.aSPUw.Score test in RV analysis}
\label{fig: PowerCurve_independenceWkCor_on_AR1data_h0.001_RVpermutedU_moreTests}
\end{figure}
\end{itemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Aim 3: Pathway-based longitudinal aSPU family tests: Path-aSPU}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{
...
\begin{tabular}{rrrrrrrrrrr}
  \hline
 & pSSU & pSSUw & pScore & pSum & pUminP & geescoreP \\
  \hline
 & 0.037  & 0.042 & 0.025 & 0.049 & 0.050 & 0.025 & \\
   \hline
\end{tabular}
...
\caption{Empirical type I error using simulation-based method in RV analysis.  \label{table:Empirical type I error using simulation-based method in pathway analysis}}
\end{table}
...
\vspace{-10pt}
\caption{Empirical power benchmark using simulation-based method in pathway analysis}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Real Data Application}\label{sec:data}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{Real Data Result Demo}\label{sec:data-result}
%\frame{
%\frametitle{Table of Contents}
%\tableofcontents[currentsection,currentsubsection]
%}
\frame{
\scriptsize
\frametitle{Real Data Result Demo}
\begin{figure}[H]
\centering
\includegraphics[height=0.7\textheight]{{{figure/ARIC_exome/Manhattan_plot_aspu_weighted_sco_P_geneBased_whole-genome}}}
\caption{Manhattan Plot of aSPUw.score test on ARIC data Total Cholesterol trait}
\label{fig: Manhattan_plot_aspu_weighted_sco_P_geneBased_whole-genome}
\end{figure}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
