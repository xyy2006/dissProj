...
To help the audience to gain a fast and general understanding of the ARIC data two components, I borrow a flowchart from the ARIC website here as in Figure \ref{fig: ARICcomponents}
\begin{figure}[H]
\centering
